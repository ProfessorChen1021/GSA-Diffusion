"""
Build entity masks with GroundingDINO and SAM.
"""
...
def _trim_mask_overlaps(masks: Dict[str, torch.Tensor]) -> None:
    """Trim overlaps in place so one region does not belong to two entities."""
...
def _detect_entity_boxes(
    ...
    """Run GroundingDINO and keep the highest-scoring boxes."""
